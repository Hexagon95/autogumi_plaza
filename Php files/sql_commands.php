...
class SqlCommand{
    ...
    public function select_tabletMunkalapEsetiReszletezo()      {return "SELECT * FROM [local].[Tablet_Munkalap_eseti_reszletezo] (:eszkoz_id, :datum, :foglalas_id, :parent_id, :user_id)";}
